...
return [
    'BE' => [
        ...
        'installToolPassword' => '$argon2i$v=19$m=65536,t=16,p=1$NlJtUzNLcG44LkouckZJZw$4pbyTov7HXbSHJYXb6FDVw/V2uyOagbBo+IXz+9CK30',
    ...
    'DB' => [
        'Connections' => [
            'Default' => [
                'charset' => 'utf8mb4',
                'dbname' => 'usr_p571069_1',
                'driver' => 'mysqli',
                'host' => 'db001155.mydbserver.com',
                'password' => 'D6p%=9dczai8',
                'port' => 3306,
                'tableoptions' => [
                    'charset' => 'utf8mb4',
    ...
    'SYS' => [
        ...
        'devIPmask' => '',
        'displayErrors' => 0,
        'encryptionKey' => '97dfa50eff2124019ed7d4df69a8afa15932e94d36bd03331f71919cfc4d1a616269bdc108f3a764210ea683ca17ea6a',
